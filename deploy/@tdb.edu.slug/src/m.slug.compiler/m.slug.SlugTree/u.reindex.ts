...
export const reindex: t.SlugTreeReindex = (args) => {
...
function indexOrder(tree: t.SlugTreeItems, keyMode: t.SlugTreeReindexKey): OrderIndex {
...
function nodeKey(node: t.SlugTreeItem, keyMode: t.SlugTreeReindexKey): string {
