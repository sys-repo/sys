...
import { type t, CanvasSlug, DEFAULTS, Image, Player } from './common.ts';
...
export function factory() {
  ...
  const content: t.VideoContent = {
    ...
    timestamps: {
      ...
      '00:01:01.000': (p) => <Slug {...p} text={'sense making'} />,
      ...
      '00:03:04.660': (p) => <Slug {...p} />,
      '00:03:10.000': {
        column: (p) => <Slug {...p} logo={'SLC'} />,
        pulldown: (p) => <Image.View src={Images.refine()} />,
      },
      '00:03:15.730': (p) => <Slug {...p} text={'high\npotential'} />,
      '00:03:19.250': {
        column: (p) => <Slug {...p} logo={'SLC'} />,
