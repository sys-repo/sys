 ...
 */
export const toPlaybackSpec: t.SlugSequenceLib['toPlaybackSpec'] = async (
  dag,
  yamlPath,
  docid,
  opts,
  ...
  const normalized = Normalize.toTimecode(sequence, { docid, yamlPath });
...
/**
 * Internal helper: project a normalized SlugSequence into the playback spec
 * wire format used by bundler/UI.
 */
