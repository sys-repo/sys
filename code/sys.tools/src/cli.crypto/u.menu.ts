 ...
 */
export async function promptTemplateVariant(): Promise<t.CryptoTool.TemplateVariant | undefined> {
  while (true) {
    const picked = (await Cli.Input.Select.prompt<t.CryptoTool.MenuCmd>({
      message: '\nTemplate Variant:',
      options: [
