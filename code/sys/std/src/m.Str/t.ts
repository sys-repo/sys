...
/**
 * Type contracts for working on strings of text.
 */
export namespace Str {
  ...
  export type Lib = {
    ...
    readonly Compare: Compare.Lib;

    /** The "lorem ipsum" helper library. */
    readonly Lorem: Lorem.Lib;
  ...
  /**
   * Type contracts for string comparison algorithms.
   */
  export namespace Compare {
    ...
    export type Lib = {
       ...
       */
      natural(options?: Options): (a: string, b: string) => number;
    };
