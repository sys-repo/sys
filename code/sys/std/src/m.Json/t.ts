import type { Json as JsonValue, JsonString, StdError } from '@sys/types';

export type Json = JsonValue;

type JsonInput = JsonString | undefined;
...
export type JsonParseResult<T> = { ok: boolean; data: T; error?: StdError };
