...
export function isHexColor(input: string): input is t.Color.Hex {
  return RX_HEX.test(input);
}

export function isRgbColor(input: string): input is t.Color.Rgb {
  return RX_RGB.test(input);
}

export function isRgbaColor(input: string): input is t.Color.Rgba {
  return RX_RGBA.test(input);
}

export function isAlphaColorInput(input: string): input is t.Color.AlphaInput {
  return isHexColor(input) || isRgbColor(input) || isRgbaColor(input);
}

export function assertHexColor(input: string, method: string): asserts input is t.Color.Hex {
...
export function assertAlphaColorInput(
  input: string,
  method: string,
): asserts input is t.Color.AlphaInput {
