import type { Immutable as ImmutableBase } from '@sys/types';
import type { t } from './common.ts';

type O = Record<string, unknown>;

/**
 * Root immutable contract, merged with nested immutable helper namespaces.
 */
export type Immutable<T = O, P = unknown> = ImmutableBase<T, P>;

/**
 * Immutable helper contracts.
 */
export declare namespace Immutable {
  ...
  export namespace Url {
    ...
    export namespace Dsl {
       ...
       */
      export type Ref<C> = {
        readonly url: Immutable.Url.RefReadonly;
        readonly current: C;
