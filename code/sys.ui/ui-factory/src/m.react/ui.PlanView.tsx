 ...
 */
export const ReactPlanView = <F extends t.Factory<any, any>>(props: ReactPlanViewProps<F>) => {
  ...
  for (const [slot, childOrList] of Object.entries(resolved.slots ?? {})) {
    if (Array.isArray(childOrList)) {
      // Keying strategy: stable enough for harness; adapter path remains key-agnostic.
