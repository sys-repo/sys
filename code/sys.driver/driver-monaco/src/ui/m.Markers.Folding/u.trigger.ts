...
export const fold: t.EditorFolding.Lib['fold'] = (editor, start, end = start) => {
...
export const unfold: t.EditorFolding.Lib['unfold'] = (editor, start, end = start) => {
...
export const clear: t.EditorFolding.Lib['clear'] = (editor) => {
