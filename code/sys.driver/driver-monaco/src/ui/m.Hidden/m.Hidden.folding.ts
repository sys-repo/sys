...
export const fold: t.EditorHiddenLib['fold'] = (editor, start, end = start) => {
...
export const unfold: t.EditorHiddenLib['unfold'] = (editor, start, end = start) => {
...
export const clear: t.EditorHiddenLib['clear'] = (editor) => {
