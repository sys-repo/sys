...
/**
 * AUTO-GENERATED by `code/sys.driver/driver-agent/-scripts/task.prep.ts`.
 * Keeps the fallback deterministic when no local `deps.yaml` is present.
 */
export const PI_CODING_AGENT_IMPORT = 'npm:@mariozechner/pi-coding-agent@0.67.68' as const;
