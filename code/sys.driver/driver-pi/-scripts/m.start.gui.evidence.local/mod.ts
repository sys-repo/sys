...
export const EVIDENCE_GENERATED_MESSAGE =
  `Driver Pi local GUI evidence generated: ${OUTPUT_RELATIVE_PATH}`;
...
/** Verify one saved local candidate before replacing the launcher-owned evidence leaf. */
export async function main(): Promise<void> {
  ...
  console.info(EVIDENCE_GENERATED_MESSAGE);
}
...
export function renderEvidence(input: RenderEvidenceInput): string {
  ...
  return `// AUTO-GENERATED by \`deno task start:gui:evidence:local\`.\n` +
