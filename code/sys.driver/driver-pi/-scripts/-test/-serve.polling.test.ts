import { describe, expect, it, Time } from '../common.ts';
import { pollManifest as poll } from '../-test.external/u.serve.waitFor.ts';

describe('Dist manifest polling response ownership', () => {
