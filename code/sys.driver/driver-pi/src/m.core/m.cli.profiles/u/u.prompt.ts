...
const BASE_SYSTEM_PROMPT = Str.dedent(
  ...
  - For PDF OCR or OCR setup requests, answer live callability first, then consult Pi-Driver DSL root, \`dsl profile\`, and \`dsl tools ocr-pdf\`; follow that chapter's answer contract before giving setup guidance.
